...
<html lang="ru">
    ...
    <head>
        ...
        <base href="<?= get_template_directory_uri() . '/pages/summercamp2025/' ?>">
    ...
    <body class="bg">
        <nav class="navbar navbar-dark navbar-expand-lg nav-bg">
            <div class="container-fluid">
                ...
                <a href="<?= get_permalink(368) ?>" class="nav-link nav-item camp-link">
                    ← ЗАГОРОДНЫЙ CAMP
                </a>
                    ...
                    <div class="col-12 d-block d-lg-none">
                        <div id="carouselExampleControls" class="carousel slide px-3" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <?php foreach (get_field('info-images') as $image): ?>
                        ...
                        <div class="form-wrapper">
                            <div id="form<?= $index ?>-modal-call-wrapper">
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="title" value="Городской лагерь">
                ...
                <div class="gift-_modal__body">
                    ...
                    <form action="<?= admin_url('admin-ajax.php') ?>" method="POST" class="gift-_modal__form">
                        ...
                        <div class="gift-_modal__control">
                            ...
                            <input pattern="\d+" class="gift-_modal__input" type="text" required name="child_age"
                                   id="child-age" placeholder="Возраст ребёнка" aria-errormessage="child-age-error">
                            <div class="error-message" id="child-age-error"></div>
                        </div>
                        <div class="gift-_modal__control">
                            <label for="gift-name" class="visually-hidden">Ваше имя</label>
                            <input class="gift-_modal__input" type="text" minlength="2" required name="gift_name"
                                   id="gift-name" placeholder="Ваше имя" aria-errormessage="gift-name-error">
                        ...
                        <div id="form-modal-call-wrapper">
                            ...
                            <div class="modal-body">
                                ...
                                <form onsubmit="return true;" id="form-modal-call"
                                    ...
                                    <?php if (count(get_field('shifts-items')) > 1): ?>
                                        <div class="mb-3">
                ...
                <div class="footer__bottom">
                    <div class="footer__contacts">
                        <a href="<?= home_url('/') ?>" class="footer__contacts-home-link">
                            <img class="footer__contacts-image" src="<?= $options->logoImageUrl ?>" width="191"
                                 height="174">
                        </a>
                        <strong>
                            <a class="footer__contacts-link"
                               href="tel:<?= $options->phoneNumbers ?>"><?= $options->phone ?></a>
                        </strong>
                        <strong>
                            <a class="footer__contacts-link"
                               href="mailto:<?= $options->email ?>"><?= $options->email ?></a>
                        </strong>
                        <p>
                            <?= $options->address ?>
                        </p>
            ...
            <div class="footer__camp">
                <a title="Наш лагерь на портале лагерей" aria-label="Наш лагерь на портале лагерей"
                   href="https://kidsincamp.ru/camp/supermom" target="_blank" class="footer__camp-link">
                    <img width="50" height="50" src="<?= assets('images/camp-logo.jpeg') ?>" alt=""
                         class="footer__camp-logo">
                </a>
        ...
        <script>
            $(document).ready(function () {
                $('input[type="tel"]').mask('+7(000)000-00-00', { clearIfNotMatch: true, placeholder: "+7(___)___-__-__" });
            });
        </script>
        <script
